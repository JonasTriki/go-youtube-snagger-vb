...
Public Class GoTextBox
    ...
    Private Sub CheckIconVisibility()
        If m_ShowIcon Then
            ...
            txtText.Size = New Size(Me.Width - IIf(m_ShowIsReadOnlyIcon And txtText.ReadOnly, 46, 28), Me.Height - 6)

            Me.Invalidate()
        Else
            txtText.Location = New Point(3, 3)
            txtText.Size = New Size(Me.Width - IIf(m_ShowIsReadOnlyIcon And txtText.ReadOnly, 24, 6), Me.Height - 6)
    ...
    Public Property Icon As Image
        ...
        Set(ByVal value As Image)
            If Not IsNothing(value) Then
                ...
                m_Icon = IIf(Enabled, m_NormalIcon, m_DisabledIcon)
                Me.Invalidate()
            Else
    ...
    Private Sub Controls_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MouseLeave, txtText.MouseLeave
    ...
    Private Sub Controls_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MouseEnter, txtText.MouseEnter
        If Not m_Selected Then
            m_Hover = True
            Me.Invalidate()
        End If
    ...
    Private Sub Controls_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown, txtText.MouseDown
        Focus()
        m_Selected = True
        m_Hover = False
        Me.Invalidate()
