...
Public Class GoTextBox
    ...
    Private Sub CheckIconVisibility()
        If m_ShowIcon Then
            ...
            txtText.Size = New Size(Me.Width - IIf(m_ShowIsReadOnlyIcon And txtText.ReadOnly, 46, 30), Me.Height)

            Me.Invalidate()
        Else
            txtText.Location = New Point(4, 3)
            txtText.Size = New Size(Me.Width - IIf(m_ShowIsReadOnlyIcon And txtText.ReadOnly, 24, 8), Me.Height)
