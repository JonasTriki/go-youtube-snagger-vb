Public Class VersionManager
    ...
    ''' <summary>
    ''' Determines if the application is running on Windows Vista or up.
    ''' </summary>
    Public Shared ReadOnly Property RunningOnWinVistaOrUp() As Boolean
        Get
            Return Environment.OSVersion.Version.Major >= 6 Or (Environment.OSVersion.Version.Major > 6) OrElse (Environment.OSVersion.Version.Major = 6 AndAlso Environment.OSVersion.Version.Minor >= 1)
        End Get
    End Property
End Class