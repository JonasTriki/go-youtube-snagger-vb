...
#Region "Static Colors"
    ...
    Friend Shared borderColor1 As Color = Color.FromArgb(130, 130, 130)
    Friend Shared borderColor2 As Color = Color.FromArgb(130, 130, 130)

    'Selected colors...

    Friend Shared selectedInsideTop1 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedInsideTop2 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedInsideBottom1 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedInsideBottom2 As Color = Color.FromArgb(255, 255, 255)

    Friend Shared selectedFillTop1 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedFillTop2 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedFillBottom1 As Color = Color.FromArgb(255, 255, 255)
    Friend Shared selectedFillBottom2 As Color = Color.FromArgb(255, 255, 255)

    Friend Shared selectedBorderColor1 As Color = Color.FromArgb(130, 130, 130)
    Friend Shared selectedBorderColor2 As Color = Color.FromArgb(130, 130, 130)
    ...
    fillBottom1, fillBottom2, borderColor1, borderColor2)
    Private Shared _itemToolItemCheckPressColors As New GradientItemColors(selectedInsideTop1, selectedInsideTop2, selectedInsideBottom1, selectedInsideBottom2, selectedFillTop1, selectedFillTop2, _
    selectedFillBottom1, selectedFillBottom2, selectedBorderColor1, selectedBorderColor2)
#End Region
    ...
    Protected Overrides Sub OnRenderItemCheck(ByVal e As ToolStripItemImageRenderEventArgs)
        ...
        Using uaa As New UseAntiAlias(e.Graphics)
            ...
            Using borderPath As GraphicsPath = CreateBorderPath(checkBox, _cutMenuItemBack)
                ...
                Using borderPen As New Pen(If(e.Item.Selected, _contextCheckBorderSelected, _contextCheckBorder))
                    ...
                    Select Case checkState__1
                        Case CheckState.Checked
                            ...
                            Using tickPath As GraphicsPath = CreateTickPath(checkBox)
                                ...
                                Using tickPen As New Pen(If(e.Item.Selected, _contextCheckTickSelected, _contextCheckTick), _contextCheckTickThickness)
                        ...
                        Case CheckState.Indeterminate
                            ...
                            Using tickPath As GraphicsPath = CreateIndeterminatePath(checkBox)
                                ' Draw the tick with a thickish brush
                                Using tickBrush As New SolidBrush(If(e.Item.Selected, _contextCheckTickSelected, _contextCheckTick))
        ...
        Using uaa As New UseAntiAlias(g)
            ...
            Using borderBrush As New LinearGradientBrush(backRectI, colors.cBorder1, colors.cBorder2, 90.0F)
                ...
                Using borderPen As New Pen(borderBrush)
                    ...
                    Using borderPath As GraphicsPath = DrawArc(New Rectangle(backRect.X, backRect.Y, backRect.Width + 1, backRect.Height - 1), 5)
                        g.DrawPath(borderPen, borderPath)
                    End Using
                End Using
            End Using
