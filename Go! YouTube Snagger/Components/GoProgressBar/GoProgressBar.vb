...
Public Class GoProgressBar
    ...
    Dim m_BlockColor As Color = Color.FromArgb(211, 211, 211)

    Dim m_BorderColor As Color = Color.FromArgb(160, 160, 160)
    ...
    Private Sub GoProgressBar_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        ...
        If m_ShowIcon Then
            ...
            If m_ShowText Then
                ...
                'Draw text wall...
                Dim bounds As RectangleF = GetDrawTextToGraphicsBounds(e.Graphics, If(m_ExtraText <> "", m_ExtraText & " ", "") & (m_Value / m_MaxValue) * 100 & "%", New Size(Width + Me.Height, h), m_TextFont, m_TextColor)
                ...
                'Draw text...
                DrawTextToGraphics(e.Graphics, If(m_ExtraText <> "", m_ExtraText & " ", "") & (m_Value * 100) / m_MaxValue & "%", New Size(Width + Me.Height - 1, h), m_TextFont, m_TextColor)
        ...
        Else
            ...
            If m_ShowText Then
                ...
                'Draw text wall...
                Dim bounds As RectangleF = GetDrawTextToGraphicsBounds(e.Graphics, If(m_ExtraText <> "", m_ExtraText & " ", "") & (m_Value * 100) / m_MaxValue & "%", New Size(Width, h), m_TextFont, m_TextColor)

                e.Graphics.FillPath(New SolidBrush(m_BackgroundColor), DrawArc(New Rectangle(bounds.X - 1, bounds.Y + 1, bounds.Width - bounds.X - 1, bounds.Height - bounds.Y - 1), 3))
                e.Graphics.DrawPath(New Pen(m_BorderColor, 1), DrawArc(New Rectangle(bounds.X - 1, bounds.Y + 1, bounds.Width - bounds.X - 1, bounds.Height - bounds.Y - 1), 3))

                'Draw text...
                DrawTextToGraphics(e.Graphics, If(m_ExtraText <> "", m_ExtraText & " ", "") & (m_Value * 100) / m_MaxValue & "%", New Size(Width - 1, h), m_TextFont, m_TextColor)
